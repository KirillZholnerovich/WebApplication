    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            <li class="active"><a href="films.jsp"><i class="fa fa-dashboard"></i><span>Фильмы</span></a></li>
            <li><a href="watched.jsp"><i class="fa fa-laptop"></i><span>Просмотренные</span></a></li>
          </ul>
        </section>
      </aside>
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-th-list"></i> Фильмы</h1>
            <%
              if(session.getAttribute("adding_film") != null) {
            %>
            <p><%=(String)session.getAttribute("adding_film")%></p>
            <%
              }
            %>
            <p></p>
          ...
          <div class="col-md-12">
            <div class="card">
              <h3 class="card-title">Все фильмы</h3>
